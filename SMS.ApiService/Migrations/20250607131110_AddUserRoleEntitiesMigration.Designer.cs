...
namespace SMS.ApiService.Migrations
{
    ...
    [Migration("20250607131110_AddUserRoleEntitiesMigration")]
    partial class AddUserRoleEntitiesMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMS.ApiService.Entities.Users.User", b =>
                {
                    ...
                    b.HasOne("SMS.ApiService.Entities.Users.UserProfile", "UserProfile")
                        .WithMany()
